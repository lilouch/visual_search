...
- (IBAction)savePointCloudButton:(id)sender {
    ...
    //Name of the cloud without the extension and with the obj and pcd extension
    NSString *nameCloudField = nil;
    NSString *nameCloudField_obj = nil;
    NSString *nameCloudField_pcd = nil;
    //If user click on okey, save the file
    UIAlertAction *defaultActionOk = [UIAlertAction actionWithTitle:@"OK" style:UIAlertActionStyleDefault handler:^(UIAlertAction * action) {
        //Get the text from the field
        UITextField *alertTextField = alert.textFields.firstObject;
        __block NSString *nameCloudField = alertTextField.text;
        
        // Add the obj extention
        __block NSString *nameCloudField_obj = [nameCloudField stringByAppendingString:@".obj"]; //str is now "hello world"
        ...
        //If not saved properly, pop up an error message
        if (!success)
        {
            ...
            UIAlertAction* defaultAction = [UIAlertAction actionWithTitle:@"OK"
                                                                  ...
                                                                  handler:^(UIAlertAction * action) {
                                                                      ...
                                                                      NSString *nameCloudField_pcd = [nameCloudField stringByAppendingString:@".pcd"];
                                                                      ...
                                                                      NSLog(@"filePath_tosavepcd_string: %@ ", filePath_tosavepcd);
                                                                      ...
                                                                      if (!Converter::obj2pcd(cloud_obj_string,filePath_tosavepcd_string)){
                                                                          NSError* error;
                                                                          UIAlertController* alert = [UIAlertController alertControllerWithTitle:@"Error."
                                                                                                                                         message: [NSString stringWithFormat:@"Point cloud not able to convert to pcd file: %@.",[error localizedDescription]]
                                                                                                                                  preferredStyle:UIAlertControllerStyleAlert];
                                                                          ...
                                                                          NSLog(@"OBJ point cloud converted to : %@ ", filePath_tosavepcd);
                                                                      }
    ...
    [alert addAction:defaultActionOk];
